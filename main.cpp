...
int main()
{
  ...
  // 创建着色器
  Shader shader("../shader/point_shadows.vs", "../shader/point_shadows.fs");
  Shader simpleDepthShader("../shader/point_shadows_depth.vs", "../shader/point_shadows_depth.fs", "../shader/point_shadows_depth.gs");

  unsigned int woodTexture = loadTexture(FileSystem::getPath("resource/texture/wood.png").c_str());
